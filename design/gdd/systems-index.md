...
|---|---|---|---|---|---|---|
| 1 | Relationship Depth System | Gameplay | MVP | Designed | `design/gdd/relationship-depth-system.md` | depth_tier [0,5]; SCENES_REQUIRED[5]; DIG_PASS/PARTIAL/FAIL/CRITICAL_FAIL; closed_off recoverable; no regression; scene engagementType: CORE/DEPTH/AMBIENT/RECOVERY |
...
| 9 | Scene Management / Flow Controller | Core | MVP | Designed | `design/gdd/scene-management.md` | ScriptableObject Scene Registry; pull-model GetAvailableScenes; IDLE/LOADING/RUNNING/COMPLETING/ERROR state machine; DigEntry injection on GATE_READY; gateReadyCharacters[charId→tier] |
...
| 12 | Player Profile / PC Data *(inferred)* | Core | MVP | Designed | `design/gdd/player-profile.md` | Name + 4 pronoun fields + appearance; re-editable; no upstream deps; Pillar 5 |
| 13 | Text Substitution System *(inferred)* | Narrative | MVP | Designed | `design/gdd/text-substitution-system.md` | 9 Yarn variables ($pc_name + 4 pronouns + 4 _cap variants); fallback="Traveler"/They-Them; stateless; YarnSpinner line compiler handles substitution |
| 14 | Revelation Presentation System *(inferred)* | UI | MVP | Not Started | — | #5, #16, #15 |
| 15 | Audio System / Reactive Music *(inferred)* | Audio | MVP | Designed | `design/gdd/audio-system.md` | #8 |
